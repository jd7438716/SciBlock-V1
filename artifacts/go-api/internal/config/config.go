...
type Config struct {
        ...
        // DatabaseURL is the resolved PostgreSQL connection string.
        // EXTERNAL_DATABASE_URL takes priority over DATABASE_URL — see Load().
        DatabaseURL string

        // DatabaseSource records which environment variable supplied DatabaseURL.
        // "EXTERNAL_DATABASE_URL" or "DATABASE_URL" — used only for startup logging.
...
// DatabaseURL — never includes the password or other credentials.
func (c *Config) SafeConnInfo() string {
